  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FlipProvider>(
      builder: (context,flipProvider,__) {
        return Screenshot(
          controller:flipProvider.screenshotController,
          child: Container(
            color: Colors.white,
            ...
            child: WillPopScope(
              ...
              child: Scaffold(
                  body: InkWell(
                onTap: () {
                  flipProvider.isShowTopBottomChange(flipProvider.isShowTopBottomView);
                },
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  BottomActions(
                                      ...
                                      onTap: () {
                                        log("Share");
                                       flipProvider.takeScreenshotAndShare(widget.article);
                                      }),
                                ],
                              ),
                            ),
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  flipProvider.isLoading?AppLoadingScreen():  BottomActions(
                                                      icon: "assets/svg/reload.svg",
                                                      label: 'రిలోడ్ ',
                                                      onTap: () {
                                                        log("Refresh");
