          ...
          SizedBox(
            ...
            child: Row(
              children: [
                Expanded(
                    child: NewsCard(
                        imageUrl: getHomeList![1].imageUrl!.url,
                        title: getHomeList![1].title,
                        isMainCard: false)),
                Container(
                  color: Colors.white,
                  width: 4,
                ...
                Expanded(
                    child: NewsCard(
                        imageUrl: getHomeList![2].imageUrl!.url,
                        title: getHomeList![2].title,
                        isMainCard: false))
              ],
            ),
          ),
...
class NewsCard extends StatelessWidget {
  ...
  NewsCard(
      {required this.imageUrl, required this.title, required this.isMainCard});
          ...
          child: CachedNetworkImage(
            ...
            errorWidget: (context, url, error) => Container(
              ...
              child: Center(
                child: Text(
                  "H",
                  style: fontStyle(fontSize: 10, fontWeight: FontWeight.w500),
                ),
              ),
            ),
          ),
