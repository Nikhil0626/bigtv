    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GestureDetector(
          onVerticalDragUpdate: widget.isAds? (details) {
            if (widget.isAds) {
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: CachedNetworkImageProvider(widget.article.imageUrl.url),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: widget.article.subType == "BigBlackStandard" ? Colors.black : Colors.red,
                      borderRadius: BorderRadius.only(
                ...
                Positioned(
                  bottom: widget.article.subType != "BigBlackStandard"
                      ?  bigData.toDouble()-18: data.toDouble()-18,  // Half in image, half in news
                  left: 20,
