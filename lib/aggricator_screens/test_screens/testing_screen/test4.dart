...
class _WebDashState extends State<WebDash> {
  ...
  void _onPushActionClick(Map<String, dynamic>? message, String? s) {
    ...
    print(
        "This is a Push action click callback from native to flutter. SelectedId $s");
  }

  void _onInAppPrepared(Map<String, dynamic>? message) {
    print("This is a inapp prepared callback from native to flutter. Payload $message");
  }

  void _onInAppClick(Map<String, dynamic>? message, String? s) {
    print("This is a inapp click callback from native to flutter. Payload $message");
  }

  void _onInAppShown(Map<String, dynamic>? message) {
    print("This is a callback on inapp shown from native to flutter. Payload $message");
  }
          ...
          body: ListView(
            children: <Widget>[
              ...
              new ListTile(
                ...
                onTap: () {
                  WebEngagePlugin.setUserEmail('siva143145@gmail.com');
                  showToast("Email - siva143145@gmail.com");
                },
              ),
              new ListTile(
              ...
              new ListTile(
                ...
                onTap: () {
                  log("Set UserPhone");
                  WebEngagePlugin.setUserPhone('+919951755530');
                  showToast("Phone - +919951755530");
                },
              ),
              new ListTile(
...
class WebDash extends StatefulWidget {
  @override
  _WebDashState createState() => _WebDashState();
}