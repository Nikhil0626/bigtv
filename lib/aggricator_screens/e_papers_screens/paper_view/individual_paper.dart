                  ...
                  return InkWell(
                    onTap: (){
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PapersScreenPreview(imageUrl: ePapersProvider.getSinglePapersList[index].imageUrl,),
                          ));
                    },
                    child: Card(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: ePapersProvider.getSinglePapersList[index].imageUrl,
                              fit: BoxFit.fill,
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ePapersProvider.getSinglePapersList[index].editionName,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        ePapersProvider.getSinglePapersList[index].source,
