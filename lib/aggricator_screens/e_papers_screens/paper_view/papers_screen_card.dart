            ...
            child: ePapersProvider.isMainPapers
                ...
                : ePapersProvider.getAllMainPapersList.isEmpty
                    ...
                    : Padding(
                        ...
                        child: Stack(
                          children: [
                            ePapersProvider.getAllMainPapersList.length == 1
                                ? InkWell(
                                    onTap: () {
                                      context.read<EPapersProvider>().getSingleEPapers(ePapersProvider.getAllMainPapersList[0].source, ePapersProvider.getAllMainPapersList[0].id).then(
                                        (value) {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                ...
                                : Padding(
                                    ...
                                    child: CardSwiper(
                                      ...
                                      cardBuilder: (
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            context.read<EPapersProvider>().getSingleEPapers(ePapersProvider.getAllMainPapersList[index].source, ePapersProvider.getAllMainPapersList[index].id).then(
                                              (value) {
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
