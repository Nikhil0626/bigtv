...
class IndividualPostView extends StatefulWidget {
  ...
  const IndividualPostView({super.key, required this.postId});
...
class _IndividualPostViewState extends State<IndividualPostView> {
    ...
    return Scaffold(
      body: SafeArea(
        child: Consumer<HomeProvider>(builder: (_, homeProvider, __) {
          final article = homeProvider.getAllPostList[0];
          return Stack(
            children: [
              SizedBox(
                                                                  ...
                                                                  children: [
                                                                    (article.content !=
                                                                        ...
                                                                        ? Text(
                                                                            ...
                                                                            style:
                                                                                homeScreenFontStyle(
                                                                              color: article.subType == "BigBlackStandard" ? AppColors.textColor.withOpacity(0.5) : AppColors.cardBackgroundColor,
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          WidgetSpan(
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                if (article.isReporter == true) Icon(Icons.person, size: 14, color: Colors.grey),
                                                                                if (article.isReporter == true)
                                                                                  Text(
                                                                                    ' ${article.reportedBy} | ',
  ...
  List<TextSpan> _parseText(
      BuildContext context, String text, links, HomeScreenModel article) {
    RegExp linkRegExp =
