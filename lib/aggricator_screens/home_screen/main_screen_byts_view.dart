  ...
  Widget build(BuildContext context) {
    ...
    return (widget.index + 2 > context.read<HomeProvider>().getAllPostList.length && context.read<HomeProvider>().isAiTagDataLoaded)
        ...
        : Container(
            ...
            child: (widget.article['type'] == "Standard" && widget.article['subType'] == "Reviews")
                ? Container(
                    color: Colors.white,
                    child: MovieRatings(article: widget.article),
                  )
                : InkWell(
                    onTap: () {
                                                            ...
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                onTap: () async {
                                                                  ...
                                                                  EventRepo()
                                                                      .addEvent({"share": "news", "postId": widget.article['id'].toString(), "createAt": DateTime.now().toString()}, "shared_article");
