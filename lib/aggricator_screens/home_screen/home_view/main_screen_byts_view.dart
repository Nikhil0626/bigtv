                          ...
                          child: widget.article['type'].toString() == "WebUrl"
                              ...
                              : KeepAlivePage(
                                  ...
                                  child: widget.article['type'] == "GoogleAds"
                                      ? Platform.isIOS
                                          ? IosAdsWidgetScreen(article: widget.article)
                                          : Container(
                                              color: Colors.white,
                                              child: Padding(
                                                padding: const EdgeInsets.all(8.0),
                                                  ...
                                                  ? InkWell(
                                                      onTap: () async {
                                                        ...
                                                        if (isLogin) {
                                                          ...
                                                          if(widget.article['postUrl'] =="" || widget.article['postUrl'].isEmpty()){}else{
                                                          context
                                                              .read<HomeProvider>()
                                                      ...
                                                      child: widget.article['image_url'].length==1? Image.network(
                                                                                      ...
                                                                                      return InkWell(
                                                                                        ...
                                                                                        child: SizedBox(
                                                                                          ...
                                                                                          child: SvgPicture.asset(
                                                                                              ...
                                                                                              height: 18,
                                                                                              width: 18,
                                                                                              color: settingsProvider.isLikeList.contains(widget.article['id'].toString())
                                                                                                  ? Colors.lightBlue
                                                                                                  : Colors.grey),
                                                                                        ),
                                                                                      );
