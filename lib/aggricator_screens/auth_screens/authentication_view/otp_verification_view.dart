                    ...
                    child: Center(
                      child: RichText(
                        text: TextSpan(
                          ...
                          style: newAppFont(
                              color: Colors.black, fontWeight: FontWeight.w600, fontSize:Platform.isIOS? 12.sp:14.sp),
                          children: [
                            TextSpan(
                              text: "Resend Again",
                              style: newAppFont(color: Colors.lightBlue, fontWeight: FontWeight.w600, fontSize: Platform.isIOS? 12.sp:14.sp),
                            ),
                          ],
                        ),
                      ),
