          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                "you consent to be governed by any such revisions, additions, amendments, or modifications.",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "Information the user provides to Bigtv News:",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 5),
              Text(
              ...
              height(height: 10),
              Text(
                "Email: Only user identification and authentication are done using the information. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "Information that is not specific to any one individual ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "We collect data about the user in order to uniquely validate and authenticate the device. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "To keep the user's selected images, videos, and offline news, the software needs access to the device's storage. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "The programme delivers news and content to users in accordance with their consent and in accordance with their location. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "What makes use of the data that Bigtv News gathers? ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "Bigtv News may collect and use your personal information for the following purposes:",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                ...
                "App, and/or the content of any email newsletter or other components that Bigtv News may occasionally send to You. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                ...
                "User Agreement, Terms and Conditions, and other relevant laws, Bigtv News may utilise the personal information given by the User. How Bigtv News protects user data ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                ...
                " information, the User must set access restrictions on his or her device. ",
                style: fontStyle(fontSize: 14),
              ),

              // Section 2: Data Collection
              sectionTitle(
                "Sharing identity and security details ",
              ),
              sectionContent(
              ...
              Text(
                ...
                " national security, or other causes of public importance.",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                "Bigtv News retains the right to transfer users' personal information to a third party in the case of a merger, "
                "acquisition, or sale of all or a portion of the company's assets. ",
                style: fontStyle(fontSize: 14),
              ),
              height(height: 10),
              Text(
                ...
                " account or any continuing business connections even if they are not promotional emails. ",
                style: fontStyle(fontSize: 14),
              ),

              // Section 3: How We Use Your Data
              sectionTitle(
                "Modifications to this Terms Of service ",
              ),
              sectionContent(
